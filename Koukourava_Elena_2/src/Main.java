...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Test2 - Longest phone call between 2 numbers: ");
		...
		System.out.println("Test3 - Suspicious messages between 2 numbers: ");
		for(SMS sms: listOfMessages)
			sms.printInfo();
		System.out.println();
		
		//Test 4. check whether suspects are connected
		System.out.println("Test4 - Checking connection between 2 suspects: ");
		System.out.println(s1.isConnectedTo(s3));
		System.out.println(s3.isConnectedTo(s2));
		System.out.println();
		
		//Test 5. get List of common partners
		System.out.println("Test5 - List of common partners between 2 suspects:  ");
